    ...
    .component('classListFormatter', {
        template: '<div class="slick-header-menu slick-header-menu-multiselect">\
                        ...
                        <div class="slick-header-menu-filter">\
                            ...
                            <class-formatter ng-repeat="filter in ::$ctrl.filterValues" class="cards-filter-class-group-item" \
                                             checked="filter.checked" value="filter.value" formatter-class="filter.formatterClass"\
                                             on-selection-change="$ctrl.selectionChange(filter,isSelected)"></class-formatter>\
                        </div>\
