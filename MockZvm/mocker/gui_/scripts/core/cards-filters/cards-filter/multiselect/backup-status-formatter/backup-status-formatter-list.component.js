...
angular.module('zvmApp.components')
    .component('backupStatusListFormatter', {
        template: '<div class="slick-header-menu slick-header-menu-multiselect">\
                        ...
                        <div class="slick-header-menu-filter">\
                             <label class="z-checkbox select-all-span">\
                                ...
                                <backup-status-formatter class="cards-filter-class-group-item"\
                                                        ng-repeat="filter in ::$ctrl.filterValues"\
                                                        checked="filter.checked" value="filter.value.display"\
                                                        on-selection-change="$ctrl.selectionChange(filter,isSelected)">\
                                </backup-status-formatter>\
                        </div>\
