...
angular.module('zvmApp.components')
    .component('displayListFormatter', {
        template: '<div class="slick-header-menu slick-header-menu-multiselect">\
                        ...
                        <div class="slick-header-menu-filter">\
                            ...
                            <display-formatter class="cards-filter-class-group-item" \
                                                ng-repeat="filter in ::$ctrl.filters" checked="filter.checked" display="filter.value.display"\
