...
(function() {
    ...
    angular.module('validator.provider', []).provider('$validator', function() {
        var $injector, $q, $timeout,$position;
        $injector = null;
        $q = null;
        $timeout = null;
        $position = null;
        ...
        this.convertError = function(error) {
            ...
            return function(value, scope, element, attrs) {
                var $label, label, parent, _i, _len, _ref, _results, inValidTooltip;

                //=================== custom logic =============================================================================================================================================
                errorMessage = attrs.errorMessage ?  attrs.errorMessage : errorMessage;
                inValidTooltip = '<div class="tooltip-invalid '+ attrs.placement +'"><div class="tooltip-arrow"></div><div class="tooltip-invalid-inner">' + errorMessage + '</div></div>';
                //==============================================================================================================================================================================
                    ...
                    if (parent.hasClass('form-group')) {
                       ...
                       // _ref = parent.find('label');
                        ...
                        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                            ...
                            //    $(label).remove();
                            //}
                            if ($(label).hasClass('tooltip-invalid')) {
                                $(label).remove();
                            }
                        }

                        $label = $(inValidTooltip);
                      //  $label = $("<label class='control-label error'>" + errorMessage + "</label>");
                        ...
                        //=================== custom logic =============================================================================================================================================
                        var tooltipPosition = $position.positionElements(element, $label, attrs.placement, false);
                        $label.css({top: tooltipPosition.top, left: tooltipPosition.left});
                        //==============================================================================================================================================================================
                        break;
                    }
