'use strict';
describe('Class formatter component', function () {
    ...
    beforeEach(inject(function ($rootScope, $componentController) {
        scope = $rootScope.$new();
        ctrl = $componentController('classFormatter', {$scope: scope}, {
    ...
    it('should init the display', function () {
        ...
        expect(ctrl.classNameState).toBe(ctrl.formatterClass + ' ' + ctrl.formatterClass + '-' + ctrl.value);
    });
