...
exports.config = {
  ...
  // the filename string.
  /*onPrepare: function() {// TODO this should be fixed in the CI server
    ...
    //jasmine.getEnv().addReporter(new jasmine.JUnitXmlReporter('protractor_output', true, true));
  },*/
