...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function (options, callback) {
            ...
            this.disabledDates = Array.isArray(options.disabledDates) ? options.disabledDates : [];
        ...
        clickDate: function (e) {
            //FIX FOR FILTERS DO NOT REMOVE***************//
            //THIS PREVENTS CLOSING THE FILTER DROPDOWN***//
            e.preventDefault();
            e.stopPropagation();
            //********************************************//
            var title = $(e.target).attr('data-title');
        ...
        isDateDisabled: function (date) {
            ...
            for (var i = 0, l = this.disabledDates.length; i < l && !result; i++) {
                current = this.disabledDates[i];
                current = moment.isMoment(current) ? current : moment(current);
                result = date.isSame(current, 'day');
            }
            return result;
        },
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if ((minDate && calendar[row][col].isBefore(minDate, 'day')) ||
                        ...
                        this.isDateDisabled(calendar[row][col]))
                    ) {
                        cname = ' off disabled ';
